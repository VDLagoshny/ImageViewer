namespace WFA_PictureShower
{
    partial class ConfigForm
    {
        ...
        private void InitializeComponent()
        {
			...
			this.button2.Click += new System.EventHandler(this.button2Exe_click);
			// 
			// textBox2
			// 
			...
			this.label2.Text = "Каталог с файлом запуска программы:";
			// 
			// button1
			// 
			...
			this.button1.Click += new System.EventHandler(this.button1JPG_Click);
			// 
			// textBox1
			// 
			...
			this.label1.Text = "Каталог с изображениями:";
			// 
			// groupBox2
			// 
			...
			this.button4.Click += new System.EventHandler(this.button4Cancel_Click);
			// 
			// button3
			// 
			...
			this.button3.Click += new System.EventHandler(this.button3Accept_Click);
			// 
			// ConfigForm
			// 
